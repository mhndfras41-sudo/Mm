...
SetupButton.MouseButton1Click:Connect(function()
    if SelectedTargetName ~= "" then
        ...
        AttackButton.Text = "🎯 تم التجهيز واستهداف:\n" .. SelectedTargetName
        AttackButton.BackgroundColor3 = Color3.fromRGB(0, 180, 90)
    else
        AttackButton.Text = "⚠️ اختر لاعب أولاً!"
    end
end)
...
AttackButton.MouseButton1Click:Connect(function()
    ...
    if spamActive then
        AttackButton.Text = "🛑 إيقاف الهجوم"
        AttackButton.BackgroundColor3 = Color3.fromRGB(220, 30, 30)
